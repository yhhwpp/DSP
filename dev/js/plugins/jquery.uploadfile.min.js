...
(function (b) {
    ...
    b.fn.uploadFile = function (f) {
        var p = b.extend({
            ...
            onProgress: function (percentVal) {
            },
            onFilter: function(f,e,d){},
            ...
            extErrorStr: "不允许上传. 允许上传的格式为: ",
            duplicateErrorStr: "不允许上传. 文件已经存在.",
            sizeErrorStr: "不允许上传. 允许上传的最大尺寸: ",
            uploadErrorStr: "Upload is not allowed",
            maxFileCountErrorStr: " 不允许上传. 最多可上传文件数为:",
        ...
        this.createProgress = function (y) {
            ...
            if (p.showFileCounter) {
                s = /*n.fileCounter + p.fileCounterStyle +*/
                        y
            } else {
                s = y
            }
        ...
        function r(K, E, x) {
            for (var F = 0; F < x.length; F++) {
                if (!g(E, K, x[F].name)) {
                    ...
                    K.onFilter(x[F].name, K.extErrorStr + K.allowedTypes, E);
                    continue
                }
                ...
                if (K.showFileCounter) {
                    J = /*E.fileCounter + K.fileCounterStyle + */
                            x[F].name
                } else {
                    J = x[F].name
                }
            ...
            A.change(function () {
                ...
                if (this.files) {
                    ...
                    if (!g(D, z, J)) {
                        ...
                        z.onFilter(J, z.extErrorStr + z.allowedTypes, D);
                        return
                    }
                    G.push({
                        name: J,
            ...
            var y = {
                ...
                beforeSubmit: function (J, G, I) {
                    if (C.onSubmit.call(this, z) != false) {
                        var F = C.dynamicFormData.call(this);
                        if (F) {
                            var s = i(F);
                            if (s) {
