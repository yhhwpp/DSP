...
$.extend($.fn.dataTable.defaults, {
    "language": {
        'sProcessing': '<div class="table-processing"><i class="fa fa-spinner fa-spin fa-3x"></i>&nbsp;&nbsp;&nbsp;处理中...</div>',
